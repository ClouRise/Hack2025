...
#     token.identity = str(request.user_id)
    
#     if request.user_name: #если имя пользователя передали, то присваиваем нашему токену имя пользователя
#         token.name = request.user_name
