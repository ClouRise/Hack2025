<template>
    <div class="bg-violet-50 h-full flex flex-col justify-between border-l-1 border-violet-200 relative">
        ...
        <div class="bg-violet-50 flex justify-between border-t-1 border-violet-200 px-4 py-6 items-center gap-4" style="height: 100px;">
            ...
            <img style="height: 30px; width: 30px;" class="cursor-pointer" src="../assets/icons/send_v.svg" alt="">
        </div>
    </div>
</template>
